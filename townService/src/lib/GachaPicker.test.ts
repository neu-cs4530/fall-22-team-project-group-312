...
describe('Gacha System tests', () => {
  ...
  describe('Test getters', () => {
    it('Gets the pull cost when free', () => {
      const gachapon: GachaPicker = new GachaPicker(emptyPool, free, 0, townEmitter);
      expect(gachapon.pullCost).toBe(0);
    });
    it('Gets the pull cost when not free', () => {
      const gachapon: GachaPicker = new GachaPicker(emptyPool, 10, 0, townEmitter);
    ...
    it('Gets a non-empty item pool', () => {
      const gachapon: GachaPicker = new GachaPicker(allItemsPool, free, 0, townEmitter);
    ...
    it('Gets the refund percent as a decimal', () => {
      const gachapon: GachaPicker = new GachaPicker(allItemsPool, 10, 0.1, townEmitter);
  ...
  describe('Modifying the pool', () => {
    ...
    it('Adds a new item to a non-empty pool', () => {
      const gachapon: GachaPicker = new GachaPicker(nonEmptyPool, free, 0, townEmitter);
  ...
  describe('Test interaction with Player inventory', () => {
    ...
    it('Costs players CoveyCoins per pull', () => {
      const gachapon: GachaPicker = new GachaPicker(allItemsPool, fiveCoins, 0, townEmitter);
    ...
    it('Does not remove other items in the player inventory', () => {
      const gachapon: GachaPicker = new GachaPicker(nessPool, free, 0, townEmitter);
    ...
    it('Does not refund players on non-duplicate pulls', () => {
      ...
      const gachapon: GachaPicker = new GachaPicker(nessPool, testCost, testRefund, townEmitter);
